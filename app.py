...
embedding_file_id = '11JG7oXeBQqOn69dfBXY17xcZwb9c_VGL'
embedding_file_path = 'interaction_matrix_with_embeddings.csv'
if not os.path.exists(embedding_file_path):
    import gdown
    print("Downloading interaction matrix from Google Drive...")
    gdown.download(f"https://drive.google.com/uc?id={embedding_file_id}", embedding_file_path, quiet=False)

interaction_matrix = pd.read_csv(embedding_file_path, index_col=0)

#interaction_matrix = pd.read_csv('interaction_matrix_with_embeddings.csv', index_col=0)

news_file_id = '13P4Yhmj5ZSsUtoXWJj_J0u2MP3_2fzry'
news_file_path = 'news_df_new.csv'

if not os.path.exists(news_file_path):
    import gdown
    print("Downloading news data from Google Drive...")
    gdown.download(f"https://drive.google.com/uc?id={news_file_id}", news_file_path, quiet=False)

news_df_new = pd.read_csv(news_file_path)
#https://drive.google.com/file/d/13P4Yhmj5ZSsUtoXWJj_J0u2MP3_2fzry/view?usp=drive_link
